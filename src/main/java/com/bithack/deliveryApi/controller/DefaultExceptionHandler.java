...
import com.bithack.deliveryApi.dao.DuplicateDishException;
...
public class DefaultExceptionHandler {
    ...
    @ExceptionHandler({EmptyOrderException.class, DifferentCompaniesException.class, DuplicateDishException.class})
    @ResponseBody
